...
describe ProductionsShowHelper, type: :helper do
  ...
  context 'outputting dates markup' do
    it 'first and last performance only; same dates (i.e. performs for one day only)' do
      ...
      expect(markup).to eq "<tr><td class='description-text'>Performs:</td><td>Wed, 05 Aug 2015</td></tr>"
    end
    ...
    it 'first and last performance only; same dates (i.e. performs for one day only); "booking until" set' do
      ...
      markup = create_dates_markup(production)
      expect(markup).to eq "<tr><td class='description-text'>Performs (booking until):</td><td class='emphasis-text'>Wed, 05 Aug 2015</td></tr>"
    end
    ...
    it 'first and last performance only; same dates (i.e. performs for one day only); "last date TBC" set' do
      ...
      markup = create_dates_markup(production)
      expect(markup).to eq "<tr><td class='emphasis-text'>TBC</td></tr>"
    end
    ...
    it 'dates are TBC; "dates TBC note" given' do
      ...
      markup = create_dates_markup(production)
      expect(markup).to eq "<tr><td class='emphasis-text'>TBC: Summer 2015</td></tr>"
    end
