...
describe AdminStatusController, type: :controller do
  ...
  context 'attempt super-admin status update as super-admin user' do
    it 'update super-admin status of unsuspended user types: various responses' do
      [
        {user: super_admin_user, type: 'super_admin_user', destroy: '1', id: super_admin_user.id, response: root_path},
        {user: second_super_admin_user, type: 'second_super_admin_user', destroy: '1', id: second_super_admin_user.id, response: root_path},
        {user: admin_user, type: 'admin_user', destroy: '0', id: nil, response: user_path(admin_user)},
        {user: user, type: 'user', destroy: '0', id: nil, response: user_path(user)}
      ].each do |u|
        session[:user_id] = super_admin_user.id
        expect { patch :update, user_id: u[:user], user: { admin_attributes: { }, super_admin_attributes: { _destroy: u[:destroy], id: u[:id] } } }.to change { SuperAdmin.count }.by 0
        expect(response).to redirect_to(u[:response]), "Failed: #{u[:type]}"
      end
    end

    it 'update super-admin status of suspended user types: various responses' do
      [
        {user: suspended_super_admin_user, type: 'suspended_super_admin_user', destroy: '1', id: super_admin_user.id, response: root_path},
        {user: suspended_admin_user, type: 'suspended_admin_user', destroy: '0', id: nil, response: user_path(suspended_admin_user)},
        {user: suspended_user, type: 'suspended_user', destroy: '0', id: nil, response: user_path(suspended_user)}
      ].each do |u|
        session[:user_id] = super_admin_user.id
        expect { patch :update, user_id: u[:user], user: { admin_attributes: { }, super_admin_attributes: { _destroy: u[:destroy], id: u[:id] } } }.to change { SuperAdmin.count }.by 0
        expect(response).to redirect_to(u[:response]), "Failed: #{u[:type]}"
  ...
  context 'attempt super-admin status update as suspended super-admin user' do
    it 'update super-admin status of unsuspended user types: fail and redirect to home page' do
      [
    ...
    it 'update super-admin status of suspended user types: fail and redirect to home page' do
      [
        {user: suspended_super_admin_user, type: 'suspended_super_admin_user', destroy: '1', id: suspended_super_admin_user.id},
        {user: second_suspended_super_admin_user, type: 'second_suspended_super_admin_user', destroy: '1', id: second_suspended_super_admin_user.id},
  ...
  context 'attempt super-admin status update as admin user' do
    it 'update super-admin status of unsuspended user types: all fail and redirect to home page' do
      [
        {user: super_admin_user, type: 'super_admin_user', destroy: '1', id: super_admin_user.id},
        {user: admin_user, type: 'admin_user', destroy: '0', id: nil},
        {user: second_admin_user, type: 'second_admin_user', destroy: '0', id: nil},
        {user: user, type: 'user', destroy: '0', id: nil}
      ].each do |u|
        session[:user_id] = admin_user.id
        expect { patch :update, user_id: u[:user], user: { admin_attributes: { }, super_admin_attributes: { _destroy: u[:destroy], id: u[:id] } } }.to change { SuperAdmin.count }.by 0
    ...
    it 'update super-admin status of suspended user types: fail and redirect to home page' do
      [
        {user: suspended_super_admin_user, type: 'suspended_super_admin_user', destroy: '1', id: super_admin_user.id},
        {user: suspended_admin_user, type: 'suspended_admin_user', destroy: '0', id: nil},
        {user: suspended_user, type: 'suspended_user', destroy: '0', id: nil}
      ].each do |u|
        session[:user_id] = admin_user.id
  ...
  context 'attempt super-admin status update as suspended admin user' do
    it 'update super-admin status of unsuspended user types: fail and redirect to home page' do
      [
        {user: super_admin_user, type: 'super_admin_user', destroy: '1', id: super_admin_user.id},
        {user: admin_user, type: 'admin_user', destroy: '0', id: nil},
  ...
  context 'attempt super-admin status update as non-admin user' do
    it 'update super-admin status of unsuspended user types: all fail and redirect to home page' do
      [
        {user: super_admin_user, type: 'super_admin_user', destroy: '1', id: super_admin_user.id},
        {user: admin_user, type: 'admin_user', destroy: '0', id: nil},
  ...
  context 'attempt super-admin status update as suspended non-admin user' do
    it 'update super-admin status of unsuspended user types: fail and redirect to home page' do
      [
        {user: super_admin_user, type: 'super_admin_user', destroy: '1', id: super_admin_user.id},
        {user: admin_user, type: 'admin_user', destroy: '0', id: nil},
  ...
  context 'attempt super-admin status update (assign status) when not logged in' do
    it 'fail and redirect to log in page' do
